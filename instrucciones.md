Aquí tienes el código completo para implementar estos cambios. Como solicitaste, he ajustado el menú de navegación para balancear los textos y he reescrito por completo la pantalla de estadísticas para calcular y mostrar todos estos nuevos datos.

### 1. `App.js`
Se actualizaron los nombres de las rutas en los tabs para que sean más cortos y no desbalanceen la interfaz de navegación.
    ...
    <HabitsProvider>
      <NavigationContainer>
        ...
        >
          ...
          {/* Tab oculto para poder navegar a él */}
          <Tab.Screen 
            name="Editar" 
...
### 2. `src/screens/StatsScreen.jsx`
Esta pantalla ahora procesa el historial completo de los hábitos para calcular el resumen, el rendimiento, los mejores días y la actividad de la última semana.
